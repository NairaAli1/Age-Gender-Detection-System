...
parser.add_argument('--image', default=None, help="Path to image file (optional). If not provided, webcam will be used.")
...
ageList = ['(0-10)', '(0-10)', '(0-10)', '(10-25)', '(20-35)', '(30-45)', '(40-50)', '(50+)']
